               ...
               <!-- Navigation Links -->
                @if(Auth::check())
                    ...
                    @elseif(Auth::user()->role === 'admin')
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <x-nav-link :href="route('midtrans-notification')" :active="request()->routeIs('midtrans-notification')">
                                {{ __('Midtrans Notification') }}
                            </x-nav-link>
                        </div>
                    @elseif(Auth::user()->role === 'kasir')
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <x-nav-link :href="route('home.kasir')" :active="request()->routeIs('home.kasir')">
                                {{ __('Pesan Kasir') }}
                            </x-nav-link>
                        </div>
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
