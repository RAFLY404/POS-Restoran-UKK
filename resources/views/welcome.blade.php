...
<div class="container mx-auto px-4 ">
    ...
    <label for="categoryFilter" class="text-lg font-semibold mr-2">Filter by Category:</label>
    <select id="categoryFilter" onchange="filterMenuByCategory(this.value)" class="form-select px-3 py-2 rounded-md shadow-sm text-sm leading-5 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-base">
    ...
    <div class="col-span-1">
        <div class="bg-white rounded-lg shadow-md p-4">
            ...
            <div class="mt-4 sticky bottom-0 bg-white flex flex-col sm:flex-row justify-between items-center">
                <form action="/checkoutp" method="POST" id="checkout-form" class="flex flex-wrap items-center justify-center sm:justify-between w-full">
                    @csrf
                    ...
                    <input type="text" name="customer_name" placeholder="Ex. Fransiska" id="customer_name" class="form-input rounded-md w-full sm:w-auto mb-2 sm:mb-0" value="{{ auth()->user()->name ?? '' }}">
                    <label for="customer_email" class="block text-gray-700 font-bold mb-2 mr-2 sm:mb-0">Email Pelanggan:</label>
                    <input type="text" name="customer_email" placeholder="Ex. Test@gmail.com" id="customer_email" class="form-input rounded-md w-full sm:w-auto mb-2 sm:mb-0" value="{{ auth()->user()->email ?? '' }}">
